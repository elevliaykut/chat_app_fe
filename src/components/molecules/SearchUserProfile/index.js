        ...
        <>
            <div className={styles.container}>
                ...
                <div className={styles.buttons}>
                    ...
                    <div className={styles.buttonItem} onClick={favoriteOnClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={user?.favorited_by_me ? ThemeConfig.success : ThemeConfig.black} viewBox="0 0 24 24">
                                <path d="M12 17.27L18.18 21 16.54 13.97 22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
                        </svg>
                    </div>
                    <div className={styles.buttonItem} onClick={smiledOnClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={user?.smiled_by_me ? ThemeConfig.success : ThemeConfig.black} viewBox="0 0 24 24">
                    ...
                    <div className={styles.buttonItem} onClick={blockedOnClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={user?.blocked_by_me ? ThemeConfig.success : ThemeConfig.black} viewBox="0 0 24 24">
