            ...
            <div className={styles.container}>
                <div className={styles.frame}>
                    ...
                    <div className={styles.menu}>
                        ...
                        <div style={{ marginLeft: '5px',marginTop: '8px'}} onClick={() => window.location = '/photos'}>
                    ...
                    <div className={styles.menu}>
                        ...
                        <div style={{ marginLeft: '5px',marginTop: '8px'}} onClick={() => window.location = '/posts'}>
                    ...
                    <div className={styles.menu}>
                        ...
                        <div style={{ marginLeft: '5px',marginTop: '8px'}} onClick={() => window.location = '/profile-texts'}>
                            <label className={styles.menuLabel}>Prof. Yazıları</label>
                        </div>
                    </div>
                    <div className={styles.line}/>
                    <div className={styles.menu}>
                        ...
                        <div style={{ marginLeft: '5px',marginTop: '8px'}} onClick={() => window.location = '/payments'}>
                            <label className={styles.menuLabel}>Öd. Formları</label>
                        </div>
                    </div>
                    <div className={styles.line}/>
                    <div className={styles.menu}>
                        ...
                        <div style={{ marginLeft: '5px',marginTop: '8px'}} onClick={() => window.location = '/reports'}>
                    ...
                    <div className={styles.menu}>
                        ...
                        <div style={{ marginLeft: '5px',marginTop: '8px'}} onClick={() => window.location = '/profil-photos'}>
                            <label className={styles.menuLabel}>Prof. Resimleri</label>
                        </div>
                    </div>
                    <div className={styles.line}/>
