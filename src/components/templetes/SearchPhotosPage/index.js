...
import SearchPhotosOrganisms from "../../organisms/SearchPhotosPage";
...
const mapDispatchToProps = dispatch => ({
    ...
    getUserPhotos: payload => dispatch(getUserPhotos(payload))
});

export default connect(mapStateToProps, mapDispatchToProps)(SearchPhotosOrganisms);
